                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: IntlPhoneField(
                              ...
                              pickerDialogStyle: PickerDialogStyle(backgroundColor: Colors.grey[850],),
                              onTap: () {
                                if (!isEmailCorrect) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                        ...
                        MyTextField(
                          ...
                          ontap: () {
                            if (phoneNumController.text.startsWith('0')) {
                              mobile =
                                  mobile.substring(0, 4) + mobile.substring(5);
                            }
                            if (phoneNumController.text.length < 10 ||
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                    content:
                                        Text("Invalid Mobile Number $mobile")),
                              );
                              return;
                            }
                          },
                          ...
                          children: [
                            Expanded(
                              child: MyTextField(
                                ...
                                ontap: () {
                                  if (landlineNumberController.text.length !=
                                          7 ||
                                      !isNumber(
                  ...
                  Padding(
                      ...
                      child: Button(
                        ...
                        onPressed: () async {
                          ...
                          if (websiteUrlController.text.isEmpty &&
                              websiteTitleController.text.isNotEmpty) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content: Text(
                                      "Can't Enter the title of your Website Without Enternig the Website URL")),
                          ...
                          if (instagramUrlController.text.isNotEmpty &&
                          ...
                          if (facebookUrlController.text.isNotEmpty &&
                              facebookUsernameController.text.isEmpty) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content: Text(
                          ...
                          if (instagramUsernameController.text.isNotEmpty &&
                          ...
                          if (facebookUsernameController.text.isNotEmpty &&
